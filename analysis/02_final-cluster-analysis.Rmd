...
ggsave(here("images", paste(trial_name, "wss_kmeans.png", sep = "_")), plot = within_ss_plot, width = 5, height = 3, units = "in")

avg_silhouette_plot <- silhouette_plot(n_vals, results$avg_silhouette) +
  labs(title = "Average Silhouette")

ggsave(here("images", paste(trial_name, "sil_kmeans.png", sep = "_")) , plot = avg_silhouette_plot,  width = 5, height = 3, units = "in")
...
ggsave(here("images", paste(trial_name, "wss_hclust.png", sep = "_")), plot = within_ss_plot, width = 5, height = 3, units = "in")

avg_silhouette_plot <- silhouette_plot(n_vals, results$avg_silhouette) +
  labs(title = "Average Silhouette") 
  
ggsave(here("images", paste(trial_name, "sil_hclust.png", sep = "_")), plot = avg_silhouette_plot, width = 5, height = 3, units = "in")
...
ggsave(here("images", paste(trial_name, "bic_gmm.png", sep = "_")),plot = gmm_bic_plot, width = 5, height = 3, units = "in")

avg_silhouette_plot <- silhouette_plot(n_vals, results$avg_silhouette) + 
  labs(title = "Average Silhouette") 
  
ggsave(here("images", paste(trial_name, "sil_gmm.png", sep = "_")),plot = avg_silhouette_plot, width = 5, height = 3, units = "in")
...
## Figure 1: Cluster Map. LAPD_Reporting_Districts_9190366346649101203.geojson https://data.lacity.org/resource/63jg-8b9z.json

```{r}
set_urbn_defaults(style = "map")

# read in reporting district shapefile 
rd <- st_read("/Users/kaddijatoubaldeh/Documents/Development/policing-typology/data/LAPD_Reporting_Districts_9190366346649101203.geojson",
...
ggsave(here("images", 
              paste(trial_name, "severity.png", sep = "_")), plot = severe_plot,
...
ggsave(here("images", 
              paste(trial_name, "severity_blog.png", sep = "_")), plot = severe_plot_blog,
...
ggsave(here("images", 
              paste(trial_name, "stop_rates_per_capita.png", sep = "_")), plot = stop_plot_per_capita_by_race, 
         width = 6, height = 4.5, units = "in")
...
#ggsave(file = here("images", paste(trial_name, "demographic_grid.png", sep = "_")),plot = g)

g <- (pop_poverty + pop_immigrant_noncitizen) / 
                 (hh_lim_eng + hh_renter)

ggsave(filename = here::here("images", paste(trial_name, "demographic_grid.png", sep = "_")),
       plot = g, width = 20, height = 15, units = "cm")
